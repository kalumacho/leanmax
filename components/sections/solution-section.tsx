    ...
    <section className="py-24 px-6 bg-[#0F1E2E]">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="mt-4 text-white/30 text-sm max-w-md mx-auto">
            Cliquez sur un nœud pour explorer. Chaque composant est connecté aux autres.
          </p>
        </div>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="rounded-2xl p-8 border" style={{ background: "rgba(26,58,92,0.25)", borderColor: "rgba(26,58,92,0.5)" }}>
          ...
          <div className="rounded-2xl p-8 border" style={{ background: "rgba(232,196,122,0.05)", borderColor: "rgba(232,196,122,0.25)" }}>
